...
import { getProducts, getProduct, createProduct, deleteProduct, adjustStock } from '../api/products'
...
export default function Products() {
  ...
  const handleStockAdjust = async (e) => {
    ...
    try {
      ...
      const updated = await getProduct(stockTarget.id)
      setItems((current) =>
        current.map((item) => item.id === stockTarget.id ? updated.data.data : item)
      )
      setStockTarget(null)
